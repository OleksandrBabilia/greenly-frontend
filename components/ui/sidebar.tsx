...
export function Sidebar({
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-20 w-64 bg-white border-r border-green-100 transition-transform duration-300 transform ${
    ...
    >
      <div className="flex items-center justify-between h-16 px-4 border-b border-green-100">
        ...
        <Button variant="ghost" size="icon" onClick={() => setSidebarOpen(false)} className="md:hidden text-green-600">
          <X className="w-5 h-5" />
        </Button>
      </div>

      <div className="p-4">
        <Button onClick={createNewChat} className="w-full mb-4 bg-green-600 hover:bg-green-700 text-white">
